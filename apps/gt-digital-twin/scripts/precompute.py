...
def main():
    ...
    payload = {
        ...
        "calibration_register": {
            ...
            "wear_constants": {"status": "assumed_industry", "source": "GER-3620 equivalent-hours, Kumar 2012 start C&M, F-class fatigue/TBC literature.",
                               "why_v1": "Wear physics defensible at literature/vendor level (Tier-2 cited). Sensitivity rank in parameter_calibration_register §3.",
                               "upgrade": "Friday load-temp paper + MOR EFOR calibration → Tier-3 calibrated."},
        }
    }
